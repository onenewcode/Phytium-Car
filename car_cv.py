...
class CarCV:
    ...
    def __init__(self):
        ...
        self.detector = ColorDetector(self.lower_tennis, self.upper_tennis, min_area=300)
    ...
    def handle_target_lost(self, current_time):
        ...
        if self.lost_count >= self.max_lost_frames:
            if not self.target_found:
                ...
                self.search_direction = 1 if self.last_valid_position and self.last_valid_position[0] > self.width / 2 else -1
